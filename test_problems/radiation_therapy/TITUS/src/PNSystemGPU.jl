...
function SetupSystemMatrices(obj::PNSystem)
    ...
    return Ax,-Ay,-Az # swap sign to match our definition of the real spherical harmonics in utilities.jl
end
...
function SetupSystemMatricesSparse(obj::PNSystem)
    ...
    obj.Ax = CuSparseMatrixCSC(sparse(Ix, Jx, - obj.T.(valsx), nTotalEntries, nTotalEntries)) # swap sign to match our definition of the real spherical harmonics in utilities.jl
    obj.Ay = CuSparseMatrixCSC(sparse(Iy, Jy, - obj.T.(valsy), nTotalEntries, nTotalEntries)) # swap sign to match our definition of the real spherical harmonics in utilities.jl
